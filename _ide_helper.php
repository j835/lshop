...
')
     ...
     */ 
         ...
         * @static 
         */ 
        public static function push($name, $code)
        {
                        /** @var \App\Services\BreadcrumbService $instance */
                        return $instance->push($name, $code);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        public static function getSession()
        {
                        /** @var \App\Services\CartService $instance */
                        return $instance->getSession();
        }
                    /**
         * 
         ...
         * @static 
         */ 
        public static function push($product_id, $quantity)
        {
                        /** @var \App\Services\CartService $instance */
                        return $instance->push($product_id, $quantity);
        }
                    /**
         * 
         *
     ...
     */ 
        ...
        {
                        /** @var \App\Services\SeoService $instance */
...
namespace  { 
            ...
            class Cart extends \App\Facades\Cart {}
